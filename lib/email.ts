    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/dashboard" class="button">View Task Dashboard</a>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div style="text-align: center;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/intern/progress" class="button">View Your Achievements</a>
          </div>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div style="text-align: center;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/intern/progress" class="button">View Full Evaluation</a>
          </div>
